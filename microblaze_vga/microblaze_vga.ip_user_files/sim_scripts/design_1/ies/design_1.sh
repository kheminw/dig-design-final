...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../microblaze_vga.srcs/sources_1/bd/design_1/ipshared/100a" \
       +incdir+"$ref_dir/../../../../microblaze_vga.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl" \
       +incdir+"../../../../microblaze_vga.srcs/sources_1/bd/design_1/ipshared/100a" \
       +incdir+"../../../../microblaze_vga.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl"
}
